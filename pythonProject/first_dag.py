...
# В параметрах имя Dag и начало действия - тут с момента запуска программы
dag = DAG(  dag_id="task_dag",
            start_date=day_ago(0,0,0,0,0),
            schedule_interval=None,
            )
# Операция, которая будет запускать Dag
operation = PythonOperator(
    python_callable=main,
    dag=dag,
    task_id='first_operation'
)
